 ...
 * @property {'easy'|'medium'|'hard'} difficulty - 皇帝难度等级
 */
 ...
 * @property {'easy'|'medium'|'hard'|null} selectedDifficulty - 选择的难度等级
 */
 ...
 * @param {'easy'|'medium'|'hard'} difficulty - 难度等级（默认为 'medium'）
 * @returns {Emperor}
 */
function createEmperor(id, name, templeName, posthumousName, reignNames, dynasty, reignStart, reignEnd, hints, difficulty = 'medium') {
    return {
        id,
        name,
        templeName,
